 ...
 * @method     ChildOpinionQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildOpinionQuery orderByNick($order = Criteria::ASC) Order by the nick column
 * @method     ChildOpinionQuery orderByData($order = Criteria::ASC) Order by the data column
 * @method     ChildOpinionQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 *
 * @method     ChildOpinionQuery groupById() Group by the id column
 * @method     ChildOpinionQuery groupByName() Group by the name column
 * @method     ChildOpinionQuery groupByNick() Group by the nick column
 * @method     ChildOpinionQuery groupByData() Group by the data column
 * @method     ChildOpinionQuery groupByCreatedAt() Group by the created_at column
 *
 ...
 * @method     ChildOpinion findOneByName(string $name) Return the first ChildOpinion filtered by the name column
 * @method     ChildOpinion findOneByNick(string $nick) Return the first ChildOpinion filtered by the nick column
 * @method     ChildOpinion findOneByData(string $data) Return the first ChildOpinion filtered by the data column
 * @method     ChildOpinion findOneByCreatedAt(string $created_at) Return the first ChildOpinion filtered by the created_at column *
 ...
 * @method     ChildOpinion requireOneByName(string $name) Return the first ChildOpinion filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOpinion requireOneByNick(string $nick) Return the first ChildOpinion filtered by the nick column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOpinion requireOneByData(string $data) Return the first ChildOpinion filtered by the data column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOpinion requireOneByCreatedAt(string $created_at) Return the first ChildOpinion filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildOpinion[]|ObjectCollection findByName(string $name) Return ChildOpinion objects filtered by the name column
 * @method     ChildOpinion[]|ObjectCollection findByNick(string $nick) Return ChildOpinion objects filtered by the nick column
 * @method     ChildOpinion[]|ObjectCollection findByData(string $data) Return ChildOpinion objects filtered by the data column
 * @method     ChildOpinion[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildOpinion objects filtered by the created_at column
...
abstract class OpinionQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'webdb', $modelName = '\\Opinion', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, nick, data, created_at FROM opinion WHERE id = :p0';
        try {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(OpinionTableMap::COL_NAME, $name, $comparison);
    }
     ...
     * $query->filterByNick('%fooValue%', Criteria::LIKE); // WHERE nick LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByNick($nick = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(OpinionTableMap::COL_NICK, $nick, $comparison);
    }
    ...
    public function filterByData($data = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(OpinionTableMap::COL_DATA, $data, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(OpinionTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(OpinionTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OpinionTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
